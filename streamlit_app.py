...
st.markdown("""
**빨간색 선(기온 변화)**으로 표시된 '기온 이상치'는 과거 특정 기간(1951~1980년)의 평균 기온을 기준으로, 현재 기온이 얼마나 높거나 낮은지를 나타내는 지표입니다. 
...
st.markdown("""
**1. 작은 실천의 중요성** 일상 속에서 무심코 사용하는 에너지를 절약하고, 일회용품 사용을 줄이는 작은 습관이 모여 큰 변화를 만들 수 있습니다.
